...
class logTestCase(TestCase):
    ...
    def test_count(self):
        ...
        ProductNutrition.objects.create(product=product, nutrition=nutrition, value=100)
        container = Container.objects.create(name='jar')
        ContainerProduct.objects.create(container=container, product=product, mass=500)
        ContainerMass.objects.create(container=container, mass=450)
